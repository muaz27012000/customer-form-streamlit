...
dokumen_pengiriman = st.text_input("10. Dokumen Pengiriman")
...
dokumen_tukar_faktur = st.text_input("15. Dokumen Tukar Faktur")
...
if st.button("💾 Simpan"):
    ...
    # --- Generate PDF di folder temporary ---
    with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as tmpfile:
        pdf_file = tmpfile.name
    generate_pdf(data, lampiran_files, pdf_file)

    with open(pdf_file, "rb") as f:
        st.download_button("⬇️ Download PDF Customer Form", f,
                           file_name="customer_form.pdf", mime="application/pdf")

# --- Tombol Download Database ---
if os.path.exists(db_file):
    with open(db_file, "rb") as f:
        st.download_button("⬇️ Download Database Customer", f,
